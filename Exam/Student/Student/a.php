...
if(!isset($_SESSION[$test_id])){$_SESSION[$test_id] = mktime(date(G),date(i),date(s),date(m),date(d),date(Y)) + $time_limit;} // Add $time_limit (total time) to start time. And store into session variable.
