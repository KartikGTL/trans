...
<div id="container">
	<div class="shell">
	 ...
	 <select name="paper" id="paper" onchange="window.document.form1.submit();">
...
?>
						...
						<center><table width="752" border="0" align="center" cellspacing="0" bordercolor="#FBFCFC">
						  <form id="form1" name="form1" method="post" action="Create_Test_Insert.php">
						  <tr>
    <td width="243" height="49"><span class="style3">Select Paper</span> </td>
    <td width="505">
      <label>
...
?>
  ...
  <tr>
   ...
   <tr>
    ...
    <td width="505">
      <label>
        <input name="nq" type="text" id="nq" size="10" maxlength="10" />
        </label>    </td>
  </tr>
   <tr>
    ...
    <td width="505">
      <label>
        <input name="time" type="text" id="time" size="10" maxlength="50" />
        </label>
